...
public class RegisterUserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //prepare a information message for user about the success or failure of the operation
        String infoMessage = null;
        if(rows==0){
            infoMessage = "Sorry, an error ocurred!";
        }
        else{
            infoMessage = "User registered sucessfully!";
        }

        //white the message back to the page in client browser
